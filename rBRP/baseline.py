...
class RolloutBaseline:
    def __init__(self, 
        ...
        #Dataset
        self.dataset = MultipleGenerator(self.device, batch=512, n_samples=self.n_rollout_samples, epoch=epoch, is_validation=True).get_dataset()
    ...
    def epoch_callback(self, model, epoch):
        ...
        if self.alpha < 1.0:
            self.alpha = (self.cur_epoch + 1) / float(self.warmup_epochs)
