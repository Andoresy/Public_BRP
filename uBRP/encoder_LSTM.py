...
class GraphAttentionEncoder(nn.Module):
    def __init__(self, n_heads = 8, embed_dim=32, n_layers=3, max_stacks=4, max_tiers=4, n_containers = 8, normalization = 'batch', ff_hidden = 512):
        super().__init__()
        self.n_heads = n_heads
        self.embed_dim = embed_dim
    ...
    def forward(self, x, mask=None):
        ...
        h = hidden_state.view(batch, max_stacks, self.embed_dim)
        x = self.LSTM_embed(h)
